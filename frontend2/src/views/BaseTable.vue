    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-input style="width:300px;" v-model="query.name" placeholder="漏洞信息" clearable></el-input>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column label="Detail" align="center">
                    <el-button type="primary" @click="goDetail([id])">查看详情</el-button>
                </el-table-column>
...
import { fetchData, getAllData,getList } from "../api/index";
...
export default {
    ...
    methods: {
        goDetail(row) {
            this.$router.push({path:'/vuln', params: row})
        }
    }
};
</script>
