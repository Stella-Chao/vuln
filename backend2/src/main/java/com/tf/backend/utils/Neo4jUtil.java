...
import com.tf.backend.model.domain.Cpe;
...
import com.tf.backend.repository.graph.CVSSRepository;
import com.tf.backend.repository.graph.ProductRepository;
import com.tf.backend.repository.graph.TypeRepository;
import com.tf.backend.repository.graph.VulnRepository;
